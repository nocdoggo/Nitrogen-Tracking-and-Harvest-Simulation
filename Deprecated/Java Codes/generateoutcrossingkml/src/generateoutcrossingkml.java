...
public class generateoutcrossingkml
{
  private int expcount = 5;
  private int latloncount = 15000;
  private int[] count9to13;
  private double[][][] arr_explatlon;
  private String folder = "";

  public generateoutcrossingkml()
  {
  ...
  public void readfile()
  {
    try
    {
      ...
      while ((linestr = textreader.readLine()) != null) {
        ...
        double curr_val = Double.valueOf(strdata[6]).doubleValue();
        ...
        if(this.count9to13[concexp]>=400)System.out.println("bounds exceeded!");
      }
      textreader.close();
      fr.close();
    }
  ...
  private void writekmlcode() {
    ...
    try {
            ...
            //Read gridsize from file and store in variable gridsize
            ...
            try {
              ...
              fw = new FileWriter(this.folder + "\\outcrossing.kml");
              ...
              textwriter.write("<Icon><href>outcrossinglegend.png</href></Icon>\r\n");
              ...
              Logger.getLogger(generateoutcrossingkml.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
              try {
                textreader.close();
                fr.close();
  ...
  public static void main(String[] args) {
    generateoutcrossingkml g = new generateoutcrossingkml();
    g.folder = args[6];
    g.readfile();
    g.showvalues(10);
    g.writekmlcode();
