 ...
 * @author Me
 */
public class generatepollensetupfile {
    public void createfile(){
        ...
        try {
            ...
            int linecount = 1;
            FileReader fr = new FileReader("pollenstrengthdata");
...
//            System.out.println(splitted[2]);
            ...
            Logger.getLogger(generatepollensetupfile.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                bw.close();
                fw.close();
    ...
    public static void main(String args[]){
        generatepollensetupfile g = new generatepollensetupfile();
