...
public class generatedepositionkml
{
  ...
  public void readfile()
  {
    try
    {
      ...
      while ((linestr = textreader.readLine()) != null) {
        ...
        double curr_val = Double.valueOf(strdata[4]).doubleValue();
  ...
  private void writekmlcode() {
    ...
    try {
            ...
            try {
              ...
              fw = new FileWriter(this.folder + "\\deposition.kml");
              ...
              textwriter.write("<Icon><href>depositionlegend.png</href></Icon>\r\n");
              ...
              Logger.getLogger(generatedepositionkml.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
              try {
                textreader.close();
                fr.close();
  ...
  public static void main(String[] args) {
    generatedepositionkml g = new generatedepositionkml();
    g.folder = args[6];
    //g.folder = "sudeep";
    g.readfile();
    g.showvalues(10);
