...
CultivarBatchFile<-"McCurdy_84aa.MZC";
...
WorkDirectory<-getwd();
WorkDirectorySubstrings<-unlist(strsplit(WorkDirectory,"DSSAT46"));

DSSATD<-paste(WorkDirectorySubstrings[1],"DSSAT46", sep=""); #Get the working directory of DSSAT.
...
{
CurrentGenotypeFile<-paste(GD, "/MZCER046.CUL", sep="");
} else if (CropName == "SC")
{
CurrentGenotypeFile<-paste(GD, "/SCCAN046.CUL", sep="");
} else if (CropName == "SW")
{
CurrentGenotypeFile<-paste(GD, "/SWCER046.cul", sep="");
}else if  (CropName == "WH")
{
CurrentGenotypeFile<-paste(GD, "/WHCER046.CUL", sep="");
}else if  (CropName == "BA")
{
CurrentGenotypeFile<-paste(GD, "/BACER046.CUL", sep="");
}else if  (CropName == "RI")
{
CurrentGenotypeFile<-paste(GD, "/RICER046.CUL", sep="");
}
...
#".CUL" under the "Genotype" folder of DSSAT, it was set as "MZCER046.CUL" as default value.
...
#while 8 is the length of cultivar file name, such as "MZCER046".
...
##"DSSBatch.v46" in the output directory.
