...
eval(parse(text=paste('Evaluation<-read.table("',OD,
'/EvaluateFrame_1.txt", header=TRUE,comment.char="")',sep = '')));
#print(Evaluation);
...
if (CropName=="PT" || CropName=="SC" || CropName=="CS" || CropName=="TN" || CropName=="TR" || CropName=="WH")
{
